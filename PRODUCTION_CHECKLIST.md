...
RESEND_FROM_EMAIL="Vivance <noreply@yourdomain.com>"
RESEND_WEBHOOK_SECRET="[From Resend webhooks settings]"
#
# Resend setup steps:
# 1. Verify your sending domain in the Resend dashboard
# 2. Add the required DNS records (SPF/DKIM) in your DNS provider
# 3. Confirm the domain status is "Verified" before sending
...
# Use Webpack build in CI / restricted environments
...
#### Webhooks
- [ ] Configure Resend webhook endpoint: `/api/webhooks/resend`
- [ ] Set `RESEND_WEBHOOK_SECRET` in production
- [ ] Verify delivery/bounce events are received and stored
...
- [ ] Retention policy (e.g., 7-30 days) in place
