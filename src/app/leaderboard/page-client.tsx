...
function LeaderboardContent() {
  ...
  const signInHref = `/sign-in?redirect=${encodeURIComponent('/leaderboard')}`
    ...
    <div className="space-y-8">
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Button asChild size="sm">
              <Link href={signInHref}>Sign In for Personal Rank</Link>
            </Button>
          </CardContent>
        </Card>
      )}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {/* Time period tabs */}
          <div>
            <p className="text-sm font-medium text-muted-foreground mb-2 block">Time Period</p>
          ...
          {/* Type selector */}
          <div>
            <p className="text-sm font-medium text-muted-foreground mb-2 block">Category</p>
            <div className="flex flex-wrap gap-2">
