...
export default function PricingPage({ initialIsAuthenticated }: PricingPageProps) {
  const { isAuthenticated: hydratedIsAuthenticated } = useAuth()
  const isAuthenticated = hydratedIsAuthenticated || initialIsAuthenticated
