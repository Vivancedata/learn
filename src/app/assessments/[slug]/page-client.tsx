...
function AssessmentDetailContent({
  ...
  const handleStartAssessment = () => {
    if (!user) {
      router.push(`/sign-in?redirect=${encodeURIComponent(`/assessments/${slug}`)}`)
      return
    }
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="p-4 bg-muted/50 rounded-lg text-center">
                  ...
                  <p className="text-2xl font-bold">{user ? (userStats?.attempts || 0) : '—'}</p>
                  <p className="text-sm text-muted-foreground">
                    {user ? 'Your Attempts' : 'Sign in to track attempts'}
                  </p>
                </div>
              </div>
            ...
            <CardFooter>
              ...
              >
                ...
                {user ? (hasAttempts ? 'Retake Assessment' : 'Start Assessment') : 'Sign In to Start Assessment'}
              </Button>
            </CardFooter>
          </Card>
        </div>
              ...
              {!user ? (
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <Button asChild size="sm">
                    <Link href={`/sign-in?redirect=${encodeURIComponent(`/assessments/${slug}`)}`}>
                      Sign In
                    </Link>
                  </Button>
                </div>
